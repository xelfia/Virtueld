...
* `0.3.302現在`: ある時期以降の版から、メニュー操作での長押し入力がタップ（短く押す）操作で反応してしまう問題が発生しています。原因はパッケージか組み合わせの可能性もあります。対策は検討中です。
  * ⌨キーボードや🖱マウスにタップと重ならない操作方法がある場合は、それらを代用していただければ幸いです。
  * ➡[技術的補足](https://scrapbox.io/XVRF/%E9%95%B7%E6%8A%BC%E3%81%97%E5%85%A5%E5%8A%9B%E3%81%AE%E5%95%8F%E9%A1%8C)
