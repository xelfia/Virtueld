...
## `2019-07-19` 0.2.167 on `Unity 2019.1.10f1` `UniVRM 0.53.0` `VRoidSDK 0.0.17`
* `Discord`未実行時の動作を調整しました。
* 🧪`テスター限定`: マニュアルの`Discord関連機能`を参照してください。テスター限定機能の最新情報は募集ページを参照してください。
  * ロビー検索/接続/切断の動作を調整しました。
  * `👤🆚👤`メニューの動作を調整しました。
## `2019-07-18` 0.2.105 on `Unity 2019.1.10f1` `UniVRM 0.53.0` `VRoidSDK 0.0.17`
* 🧪`テスター限定`: マニュアルの`Discord関連機能`を参照してください。テスター限定機能の最新情報は募集ページを参照してください。
  * ロビー検索/接続/切断の動作を調整しました。
  * `👤🆚👤`メニューの動作を調整しました。
